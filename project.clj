(defproject io.factorhouse/cronut-javax "1.2.3"

  :description "A Clojure companion to Quartz with Javax compatibility"

  :url "https://github.com/factorhouse/cronut-javax"
  ...
  :dependencies [[org.clojure/clojure "1.12.4"]
                 ...
                 [org.quartz-scheduler/quartz "2.4.1" :exclusions [org.slf4j/slf4j-api]]]

  :profiles {:dev   {:resource-paths ["dev-resources"]
                     :dependencies   [[ch.qos.logback/logback-classic "1.3.16"]
